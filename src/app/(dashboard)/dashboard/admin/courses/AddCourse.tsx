...
import { useCreateCourseMutation } from '@/reduxApp/endPoints/courses/courseEndpoints'
...
const AddCourse = ({ isModalOpen , setIsModalOpen }:any) => {
    const {
        register,
        handleSubmit,
        reset,
        ...
        <div className={isModalOpen ? "modal-container modalshow" : "modal-container modalhide"}>
            <div className="modal-content">
                <div className="hide-modal">
                    <h1 className="modal-text">create new course</h1>
